		...
		"Items",
		{
			...
			"Deeds",
			{
				...
				"Vehicle Deeds",
				{
					...
					"Grievous Wheel Bike", "object/tangible/deed/vehicle_deed/grievous_wheel_bike_deed.iff",
					"Koro-2 Speeder", "object/tangible/deed/vehicle_deed/koro2_speeder_deed.iff"
